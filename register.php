...
// Success message if the account is created
$success = "";

// Check if the form was submitted using POST
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // Get and sanitize the username from the form
    ...
    if (empty($errors)) {
        ...
        // SQL to check if already have this user in the database
